module github.com/warmchang/k8s-95727
...
replace k8s.io/apimachinery => k8s.io/apimachinery v0.19.6-rc.1
...
replace k8s.io/code-generator => k8s.io/code-generator v0.19.6-rc.1

replace k8s.io/component-base => k8s.io/component-base v0.19.5

replace k8s.io/controller-manager => k8s.io/controller-manager v0.19.6-rc.1

replace k8s.io/cri-api => k8s.io/cri-api v0.19.6-rc.1
...
require k8s.io/kubernetes v1.19.5
